...
3.a. Como a distância entre cada ponto da escala SAEB é de 25 pontos, o MDES é de 25 e o tamanho da amostra deve ser de pelo menos 54.528

```{r chk13, echo=TRUE, message=TRUE, warning=TRUE, paged.print=TRUE}
sigma <- sd(pb$profic_mat, na.rm = TRUE)
power.t.test(n = NULL, delta = 25, sd = sigma , sig.level = 0.05, power = 0.9, type = c("two.sample"), alternative = c("two.sided"))

```


3.b. Agora a amostra deve ter tamanho 35.26

```{r chk14, echo=TRUE, message=TRUE, warning=TRUE, paged.print=TRUE}
power.t.test(n = NULL, delta = 25 / 0.8, sd = sigma , sig.level = 0.05, power = 0.9, type = c("two.sample"), alternative = c("two.sided"))

```


3.c. A amostra agora deverá ser de 39.178.
